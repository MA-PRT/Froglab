...
export default class extends Controller {
  ...
  connect() {
    console.log('controller bien connecté');
    ...
    if (file) {
      ...
      reader.onload = (event) => {
        this.previewContainerTarget.innerHTML = `
          <img src="${event.target.result}" alt="Aperçu de la photo" style="max-width: 100%; border-radius: 8px;"/>
        `;
      };
...
// ANCIEN CODE POUR PREVIEW ET PRISE PHOTO IN APP
//   static targets = [
//     "video",
//     "canvas",
//     "photoPreview",
